    ...
    <div name="about" className="w-full h-full min-h-screen  bg-[#793434] text-gray-300 " style={{ backgroundImage: `url(${Backimage})` }} id="backimgabout">
      <div className="flex flex-col justify-center items-center py-48 ">
        ...
        <div className="max-w-[1000px] w-full gap-8 px-4 text-xl">
          <div className="">
            <p className="px-2">
              Hello, I am Simon. I am a computer engineer student at Florida International University, graduating in Summer 2022.</p>
            <p className="px-2">
              ...
              websites and web applications, and I am
              now focused on web development,
              learning every day more about HTML, CSS, Javascript, and React
              ...
              Please take a look at my most recent projects and don't hesitate to contact me to connect or if you have any question
            </p>
          </div>
        </div>
      </div>
