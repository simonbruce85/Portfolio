  ...
  return (
    <div name='work' className='w-full text-gray-300 bg-[#041F31]'>
      <div className='max-w-[1000px] mx-auto py-32 p-4 flex flex-col justify-center '>
        ...
        <MdChevronRight onClick={slideRight} className='bg-white right-0 rounded-full absolute opacity-50 hover:opacity-100 cursor-pointer hidden group-hover:block' size={40}/>
    </div>
      </div>
    </div>
  )
