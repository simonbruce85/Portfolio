...
function Skills() {
  return (
    <div
      name="skills"
      className="w-full h-full min-h-screen bg-gradient-to-r from-[#061326] via-[#040c18] to-[#040c18] text-gray-300 "
    >
      {/*Container*/}
      <div className="max-w-[1300px] mx-auto p-4 flex flex-col justify-center w-full h-full md:pt-24">
        ...
        <div className="w-full grid grid-cols-2  sm:grid-cols-3 lg:grid-cols-4 gap-4 text-center py-8" data-aos="fade-up"
          ...
          >
            <div className=" shadow-md hover:shadow-xl shadow-[#0f0f0f]  md:max-w-fit rounded-md bg-[#132135] p-8  hover:-translate-y-2 duration-500 ">
